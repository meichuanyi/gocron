...
type TaskRequest struct {
	...
	Env           map[string]string      `protobuf:"bytes,5,rep,name=env,proto3" json:"env,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 注入到执行环境的环境变量(含机密),仅在执行期生效
...
const file_task_proto_rawDesc = "" +
	...
	"\x03env\x18\x05 \x03(\v2\x19.rpc.TaskRequest.EnvEntryR\x03env\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
...
var file_task_proto_goTypes = []any{
	...
	nil,                  // 2: rpc.TaskRequest.EnvEntry
}
